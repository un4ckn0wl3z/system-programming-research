...
PUBLIC	??_C@_0BD@KOOKHMLH@Initialized?5Log?4?4?4@	; `string'
...
;	COMDAT ??_C@_0BD@KOOKHMLH@Initialized?5Log?4?4?4@
CONST	SEGMENT
??_C@_0BD@KOOKHMLH@Initialized?5Log?4?4?4@ DB 'Initialized Log...', 00H ; `string'
CONST	ENDS
;	COMDAT xdata$x
xdata$x	SEGMENT
...
; Line 7
	...
	push	OFFSET ??_C@_0BD@KOOKHMLH@Initialized?5Log?4?4?4@
